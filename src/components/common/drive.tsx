...
export default function SheetsImages() {
  ...
  useEffect(() => {
    fetch('https://docs.google.com/spreadsheets/d/1419JhBkXW4tn-wNxnfM1i7XjDgnldZOLwn7wng4jiEM/pub?output=csv')
  ...
  return (
    <div className="pb-10 flex flex-wrap justify-center gap-4">
      {imageUrls.map((url, index) => (
        <div key={index} className="flex-grow flex-shrink-0 max-w-[12rem] max-h-[12rem]">
          <img
            src={url}
            alt={`Imagen ${index}`}
